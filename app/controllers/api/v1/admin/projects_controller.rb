  ...
  module V1
    module Admin
      class ProjectsController < BaseController
        ...
        before_action :set_project, only: %i[show update destroy update_image destroy_image]
        ...
        def update_image
          @project.image = params.require(:image)
          if @project.save
            render json: ProjectSerializer.new(@project).as_json
          else
            render json: { errors: @project.errors.full_messages }, status: :unprocessable_entity
        ...
        def project_params
          params.require(:project).permit(
            ...
            :status, :site_url, :repo_url, :is_featured, :sort_order,
